...
function DateField(){return <FieldWithHelp className="mt-4 block" label={<>Agreed submission date</>} helpLabel="First-submission date" help={<>Date communicated by the originating engineer for first submission.</>}><input className="ev-input" type="date" name="plannedSubmissionDate" required/></FieldWithHelp>}
