...
export function ProjectCreateForm({organisationId}:{organisationId:string}){
  ...
  return <form action={action} className="ev-card h-fit p-6">
    ...
    <HelpTip label="Project setup">Create the project record, then appoint its Project Manager and Document Controller. The Project Manager will complete the client identity, brief, objectives, schedule and resource plan, and upload the approved project template ZIP from the overview or project settings.</HelpTip>
