...
export function ProjectSCurve({curve,totalDeliverables,reportPeriodEnd}:{curve:SCurve;totalDeliverables:number;reportPeriodEnd:string}){
  ...
  return <>
    <div className="mt-4 overflow-hidden rounded-2xl border border-[#dfe7e3] bg-white p-3 sm:p-5">
      <div className="flex flex-wrap items-center justify-between gap-3 px-1"><p className="text-xs leading-5 text-[#617083]">Cumulative planned and actual progress as percentages of the total MDR scope.</p><div className="flex flex-wrap gap-4 text-[10px] font-bold uppercase tracking-[.08em] text-[#617083]"><Legend colour="#ed7138" label="Planned progress"/><Legend colour="#0c5b45" label="Actual progress"/></div></div>
