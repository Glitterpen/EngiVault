...
export async function setDocumentArchived(_:MutationState,form:FormData):Promise<MutationState>{
 ...
 if(error)return {message:`The MDR deliverable could not be ${archived?"removed":"restored"}. Reference: ${error.code}.`};
