...
import { canonicalUploadMime,hasExpectedMime,hasSupportedOrganisationLogoSignature,hasSupportedSignature,organisationLogoValidation,projectLogoValidation } from "./file-validation";
