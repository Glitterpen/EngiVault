...
Create dashboards for web request rate/latency/error ratio, authentication failures, 403/429 responses, upload completion failures, processor queue depth/oldest age/dead letters, Supabase connections/storage, signed URL errors and OpenAI usage/cost.
