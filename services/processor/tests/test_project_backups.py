...
class FakeGateway:
    ...
    def project_backup_data(self, backup_id):
        ...
        return (
            ...
            {"id": "project-1", "code": "EPC-01", "name": "EPC Project"},
            {
                ...
                "revisions": [{"id": "rev-1", "document_id": "doc-1", "revision_code": "R01", "storage_key": "source.pdf", "original_filename": "basis.pdf", "state": "ready", "sha256": hashlib.sha256(content).hexdigest()}],
    ...
    def download_key(self, storage_key, target, max_bytes):
        target.write_bytes(b"controlled engineering evidence")
